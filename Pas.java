                ...
                case "1":
                    ...
                    do{
                        if ((ocorrencia_atual=="") || (ocorrencia_atual==null)){
                            ...
                            texto_caso_1="<html><i><b>OCORRÊNCIA ADICIONADA! - RESUMO</b></i><br><br>"+
                            "OCORRENCIA: "+ocorrencia_atual+"<br>"+
                            "LOCAL: "+local_atual+"<br>"+
                            "DESCRICAO: "+descricao_atual+"<br>"+
                            "ENVOLVIDOS: "+envolvido_atual+"<br><br>"+
                            "==============================================================<br>"+
                            "O QUER FAZER AGORA? DIGITE 1 PARA ADICIONAR OUTRA OCORRÊNCIA<br>Outra opção digitada irá voltar ao Menu principal</html>";
                            ...
                            switch (opcao_2) {
                                ...
                                break;
                                default:
                                    System.out.println(ocorrencia_atual);
                                    sair_caso_1=true;
                                break;
                            }
                        };
